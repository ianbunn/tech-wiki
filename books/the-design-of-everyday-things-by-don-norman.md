...
**Affordances** make sense for interaction with physical objects. Affordance refers to the _relationship_ between a physical object and a person (or any interacting agent, animal, machines, robots, etc.). An affordance is a _relationship_ between the properties of an object and the capabilities of the agent that determine just how the object could possibly be used.
...
Affordance IS NOT a property, it is a _relationship_.

An **anti-affordance** is the prevention of interaction.

To be effective, affordances and anti-affordances have to be _discoverable_ or perceivable. If they can't be perceived, some means of signaling its presence is required: a **signifier**.
...
In _Gibsonian psychology_, an ecological approach to perception is taken, meaning the world contains the clues and the ppl simply pick them up through "direct perception".
...
2. Plan: the action Determine which of the many possible plans of action to follow
